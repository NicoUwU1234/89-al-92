	...
	//crear dos variables player1_score = 0 y player2_score = 0
	player1_score = 0;
	player2_score = 0;
...
function send() {
	...
	//extraer el valor de number 2 en la variable number2
    ...
    //crear la variable row sumando las tres variables anteriores
...
//establecer la variable answer_turn = "player2";
answer_turn = "player2";
